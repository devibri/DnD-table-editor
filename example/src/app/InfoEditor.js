...
class InfoEditor extends Component {
  ...
  render() {
      ...
      const colSpec = [
          ...
          {title: 'Text', fieldName: 'text', inputType: "TextField", width: 500},
          {title: 'Known', fieldName: 'known', inputType: "Toggle", width: 100},
          {title: 'Acted On', fieldName: 'actedOn', inputType: "Toggle", width: 100},
          {title: 'Locations', fieldName: 'locations', inputType: "TextField", width: 200},
          {title: 'Goes to', fieldName: 'goesTo', inputType: "TextField", width: 200},
          {title: 'Storyline', fieldName: 'storyline', inputType: "TextField", width: 200}
      ];
